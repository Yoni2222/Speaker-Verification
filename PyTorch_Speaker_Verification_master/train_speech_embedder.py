...
from pytorch_speaker_verification.PyTorch_Speaker_Verification_master.data_load import SpeakerDatasetTIMIT, SpeakerDatasetTIMITPreprocessed
...
def test(model_path):
    ...
    for e in range(hp.test.epochs):
        ...
        for batch_id, mel_db_batch in enumerate(test_loader):
            ...
            a, b, c = mel_db_batch.size(1), mel_db_batch.size(2), mel_db_batch.size(3)
